...
![materials_in_ict_devices](Figures/materials_in_ict_devices.png)
...
![apple_recycling](Figures/apple_recycling.jpg)
...
![plastics_flows](Figures/plastics_flows.png)
...
![battery_strategies](Figures/battery_strategies.png)
...
Back in Lecture 2, we discussed the principles of [digital sufficiency](http://dx.doi.org/10.1007/s12243-022-00914-x). Applying them to electronics means that we aim to design electronics that decrease the absolute level of resource and energy demand from their production and use. What [design principles](https://doi.org/10.1109/EGG.2016.7829823) should we apply?
...
![LM3XBMDwXlGT4MaK](Figures/LM3XBMDwXlGT4MaK.jpg)[Torn apart AirPods.](https://www.ifixit.com/Teardown/AirPods+Teardown/75578#teardownConclusion)
...
![fairphone_materials](Figures/fairphone_materials.jpg)[Use of 'fairly sourced' and recycled materials in the Fairphone 5 component supply chain.](https://www.fairphone.com/en/impact/circularity/)
...
![vneZSQRtKprBDi2W](Figures/vneZSQRtKprBDi2W.jpg)[Replacing the mainboard of a Framework laptop.](https://guides.frame.work/Guide/Mainboard+Replacement+Guide/79)
...
![framework_mainboard_case](Figures/framework_mainboard_case.png) [A Framework mainboard used as a single-board computer with a 3D-printed case.](https://frame.work/nl/en/blog/mainboard-availability-and-open-source-release)

We've now gone through a few examples of electronics, and what makes them sustainable or unsustainable. This is the end of the lecture notes for this lecture during this iteration of the course. The rest of the material for this lecture is only available in the slides.

# Feedback
We are happy to receive any feedback you may have on this lecture. Is there too much information in the slides/notes, or would you like to know more about a certain topic? Please let us know by [**filling in this form**](https://forms.cloud.microsoft/e/59zYiTyWG7).
